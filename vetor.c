...
TIPADO_(Vetor_pt) TIPADO_(criaVetor)(int n, int i, TIPO_ *elementos){ //Conferir essa parte com a Lara, o tamanho
...
TIPADO_(Vetor_pt) TIPADO_(criaCopiaVetor)(TIPADO_(Vetor_pt) vetor){
  TIPADO_(Vetor_pt) vetorNovo = TIPADO_(criaVetor)(vetor->n, vetor->i, vetor->elementos);
  return vetorNovo;
}
...
void TIPADO_(eliminaTodosElementos)(TIPADO_(Vetor_pt) vetor){
    for (int i = 0; i < vetor->n; i++){
      TIPADO_(eliminaElementoDePosicaoI)(vetor, i);
    }
} 
...
TIPADO_(Vetor_pt) TIPADO_(retornaVetorComPosicoesQueTemV)(TIPADO_(Vetor_pt) vetor, TIPO_ valor){
    ...
    if (n == 0){
      printf("Nao exite posicoes com esse valor\n");
      exit(1);
    }
    ...
    vetorComPosicoes = TIPADO_(criaVetor)(n, 0, elementos);
...
TIPADO_(Vetor_pt) TIPADO_(intercalaVetor)(TIPADO_(Vetor_pt) vetor1, TIPADO_(Vetor_pt) vetor2){
  ...
  int iv1 = 0, iv2 =0;
  TIPO_ elementos[n];
  TIPADO_(Vetor_pt) vetorNovo = TIPADO_(criaVetor)(n, 0, elementos);
